...
class WC_OneFin_EWallet_Gateway extends WC_OneFin_Payment_Gateway
{
    /**
     * @var string
     */
    ...
    {
        $this->id = 'onefin_ewallet';
        $this->icon = sprintf("%s/assets/images/onefin.png",WC_ONEFIN_PLUGIN_URL);
        $this->method_title = __('OneFin E-wallet', WC_ONEFIN_PLUGIN_TEXT_DOMAIN);
        $this->title = __('OneFin E-wallet', WC_ONEFIN_PLUGIN_TEXT_DOMAIN);
        ...
        $this->method_description = 'OneFin E-wallet chuyển hướng khách hàng tới OneFin để nhập thông tin thanh toán của họ.';
